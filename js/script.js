...
accordionHeaders[0].style.background = '#e7f1ff'; // Set background for the first accordion
...
accordionHeaders.forEach((header, index) => {
    header.addEventListener('click', () => {
        ...
        // Close all accordions and reset background colors
        ...
        accordionHeaders.forEach(h => {
            ...
            h.style.background = ''; // Reset background color for all headers
        });
        ...
        if (!isOpen) {
            ...
            header.style.background = '#e7f1ff'; // Set background for active accordion
        }
    });
});
...
document.querySelector('.eng-btn').addEventListener('click', (event) => {
    event.preventDefault(); // Prevent the anchor from scrolling to the top
    ...
    // accordionHeaders[0].querySelector('.up-arrow').style.display = 'inline-block';
    // accordionHeaders[0].querySelector('.down-arrow').style.display = 'none';
    // accordionHeaders[0].style.background = '#e7f1ff'; 
